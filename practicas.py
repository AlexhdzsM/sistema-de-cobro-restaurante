...
def click_boton(numero):
    ...
    visor_calcualdora.delete(0, END)
    visor_calcualdora.insert(END, operador)
...
def obtener_resultado():
    ...
    visor_calcualdora.delete(0, END)
    visor_calcualdora.insert(0, resultado)
    operador = ""
...
def guardar():
    ...
    archivo.close()
    messagebox.showinfo("Informacion", "Surecibo ha sido guardado")
...
#titulo de ventana
aplicacion.title("Sistema de cobro restaurante")
...
#etiqueta titulo
etiqueta_titulo = Label(panel_superior, text="Sistema de cobro", fg="azure4",font=("Dosis",58),
...
#panel costos
panel_costos = Frame(panel_izquierdo, bd=1, relief=FLAT, bg="azure4", padx=200)
...
#lista de productos
lista_comidas = ["pollo", "res", "salmon", "lasagna", "hamburguesa", "pizza1", "pizza2", "pizza3"]
lista_bebidas = ["agua", "refresco", "jugo", "cerveza1", "cerveza2", "vino1", "vino2", "tequila"]
lista_postres = ["pastel", "nieve", "fruta", "brownies", "flan", "gelatina", "cono", "cheesecake"]
...
for bebida in lista_bebidas:
    ...
    bebida= Checkbutton(panel_bebidas,
                        text=bebida.title(), font=("Dosis", 19, "bold"),
                        onvalue=1,
                        offvalue=0,
...
#Calculadora
visor_calcualdora = Entry(panel_calculadora,
                          font=("Dosis",16,"bold"),
                          width=37,
                          bd=1)
visor_calcualdora.grid(row=0,
                       column=0,
                       columnspan=4)
